...
class MostlyCloudyShowersWidget extends StatefulWidget {
  final DayState dayState;
  final double width;
  final double height;

  MostlyCloudyShowersWidget(this.dayState, this.width, this.height);

  @override
  _MostlyCloudyShowersWidgetState createState() => _MostlyCloudyShowersWidgetState();
}

class _MostlyCloudyShowersWidgetState extends State<MostlyCloudyShowersWidget> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(MostlyCloudyShowersWidget oldWidget) {
