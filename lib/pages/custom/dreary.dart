...
class DrearyWidget extends StatefulWidget {
  final DayState dayState;
  final double width;
  final double height;

  DrearyWidget(this.dayState, this.width, this.height);

  @override
  _DrearyWidgetState createState() => _DrearyWidgetState();
}

class _DrearyWidgetState extends State<DrearyWidget> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(DrearyWidget oldWidget) {
