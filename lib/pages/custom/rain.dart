...
class RainWidget extends StatefulWidget {
  ...
  RainWidget(this.dayState, this.width, this.height);

  @override
  _RainWidgetState createState() => _RainWidgetState();
}

class _RainWidgetState extends State<RainWidget> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(RainWidget oldWidget) {
